...
//     tree<reversible_node<int>> myTree;

//     // Create nodes with values 1 through n and insert them into the tree
//     for (int i = 1; i <= n; ++i) {
//         reversible_node<int>* newNode = myTree.new_node(i);
//         myTree.insert(newNode, i - 1); // Insert at position i-1
//     }
// }
